...
export const updateSettings = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      if (args.autoRefreshInterval !== undefined)
        update.autoRefreshInterval = args.autoRefreshInterval;
      if (args.notificationsEnabled !== undefined)
        update.notificationsEnabled = args.notificationsEnabled;
...
export const seedDemoData = mutation({
  ...
  handler: async ctx => {
    ...
    if (existing) {
      ...
      const hasVault = await ctx.db
        .query("vaultCodes")
        .withIndex("by_userId", q => q.eq("userId", userId))
        .first();
      const hasCollection = await ctx.db
        .query("collectionProgress")
        .withIndex("by_userId", q => q.eq("userId", userId))
        .first();
      const hasWatchlist = await ctx.db
        .query("playerWatchlist")
        .withIndex("by_userId", q => q.eq("userId", userId))
        .first();
      ...
      const hasTasks = await ctx.db
        ...
        .withIndex("by_userId", q => q.eq("userId", userId))
        .first();
      const hasModifiers = await ctx.db
        .query("activeModifiers")
        .withIndex("by_userId", q => q.eq("userId", userId))
        .first();
      const hasProfession = await ctx.db
        .query("professionStatus")
        .withIndex("by_userId", q => q.eq("userId", userId))
        .first();
      // If has all fields and all tables, skip
      if (
        existing.bank !== undefined &&
        existing.spAtkDamage !== undefined &&
    ...
    const equipmentData = [
      {
        slot: "helmet",
        itemName: "Manifestation of Mortem",
        rarity: "celestial",
        defBonus: 550,
        critPercent: 20,
      },
      {
        slot: "amulet",
        itemName: "Damaged Archdemon Amulet (Str)",
        rarity: "legendary",
        strBonus: 4050,
        critPercent: 3,
      },
      ...
      {
        slot: "special",
        itemName: "Lovely Licky Larry the First",
        rarity: "legendary",
        strBonus: 3300,
        defBonus: 2600,
        critPercent: 0.5,
      ...
      {
        slot: "pickaxe",
        itemName: "Honeycomb Pickaxe (Untradable)",
        rarity: "rare",
      },
    ...
    const warsData = [
      ...
      {
        enemyGuildId: 9201,
        enemyGuildName: "Cult of Cthulhu",
        ourScore: 1567,
        enemyScore: 1890,
        status: "ongoing",
        isBlacklisted: false,
    ...
    const targetsData = [
      {
        targetPlayerId: 12045,
        targetName: "xDarkLordx",
        targetLevel: 28500,
        targetHpPercent: 72,
        targetGuildId: 2045,
        targetGuildName: "Touhou",
        targetGold: 45000,
        targetSafeMode: false,
        isSkipped: false,
      },
      {
        targetPlayerId: 23891,
        targetName: "NightBlade99",
        targetLevel: 30100,
        targetHpPercent: 100,
        targetGuildId: 3891,
        targetGuildName: "Dark Knights",
        targetGold: 82000,
        targetSafeMode: false,
        isSkipped: false,
      },
      {
        targetPlayerId: 34567,
        targetName: "CrystalMage",
        targetLevel: 26800,
        targetHpPercent: 45,
        targetGuildId: 2045,
        targetGuildName: "Touhou",
      ...
      {
        targetPlayerId: 45678,
        targetName: "IronFist_VII",
        targetLevel: 29200,
        targetHpPercent: 88,
        targetGuildId: 7834,
        targetGuildName: "Shadow Realm",
        targetGold: 67000,
        targetSafeMode: false,
        isSkipped: false,
      },
      {
        targetPlayerId: 56789,
        targetName: "QueenBee",
        targetLevel: 27600,
        targetHpPercent: 15,
        targetGuildId: 9201,
        targetGuildName: "Cult of Cthulhu",
        targetGold: 9500,
        targetSafeMode: true,
        isSkipped: false,
      },
      ...
      {
        targetPlayerId: 78901,
        targetName: "PixelKnight",
        targetLevel: 25200,
        targetHpPercent: 91,
        targetGuildId: 4510,
        targetGuildName: "Space Pirates",
        targetGold: 32000,
        targetSafeMode: false,
        isSkipped: false,
      },
      {
        targetPlayerId: 89012,
        targetName: "MoonWalker",
        targetLevel: 31000,
        targetHpPercent: 34,
        targetGuildId: 7834,
        targetGuildName: "Shadow Realm",
    ...
    const buffsData = [
      {
        buffName: "Mortem's Blessing",
        buffType: "worship",
        expiresAt: now + 2400000,
        bonusPercent: 20,
        iconEmoji: "💀",
      },
      {
        buffName: "Sprint Boost",
        buffType: "sprint",
      ...
      {
        buffName: "Vault Bonus: Travel EXP",
        buffType: "vault",
      ...
      {
        buffName: "Vault Bonus: Battle EXP",
        buffType: "vault",
        expiresAt: now + 7200000,
        bonusPercent: 15,
        iconEmoji: "⚔️",
    ...
    const bosses = [
      {
        ...
        currentHp: 2841000,
        maxHp: 3828797,
        enableTime: Math.floor(now / 1000) - 3600,
      },
      {
        bossId: 134,
        name: "Bees",
        ...
        currentHp: 8458320,
        maxHp: 8458320,
        enableTime: Math.floor(now / 1000) - 1200,
      },
      {
        bossId: 142,
        name: "The Leviathan",
        ...
        currentHp: 15200000,
        maxHp: 22000000,
        enableTime: Math.floor(now / 1000) - 7200,
      },
      {
        bossId: 156,
        name: "Frost Wyrm",
        ...
        currentHp: 890000,
        maxHp: 5600000,
        enableTime: Math.floor(now / 1000) - 14400,
      },
    ];
    ...
    const diamonds = [
      {
        sellerId: 329952,
        sellerName: "Tounuo-Senpai",
        diamondAmount: 280,
        diamondsRemaining: 280,
        pricePerDiamond: 17857143,
      ...
      },
      {
        ...
        diamondAmount: 500,
        diamondsRemaining: 342,
        pricePerDiamond: 15000000,
        lastUpdated: "2026-05-15T08:45:00Z",
      },
      {
        sellerId: 782103,
        sellerName: "GoldRush99",
        diamondAmount: 50,
        diamondsRemaining: 50,
        pricePerDiamond: 22500000,
        lastUpdated: "2026-05-14T23:15:00Z",
      },
    ];
    ...
    const marketItems = [
      {
        ...
        rarity: "legendary",
        type: "weapon",
        currentLow: 450000000,
        currentHigh: 680000000,
        lastPrice: 520000000,
        priceHistory: [
        ...
        circulation: 23,
        notes: "My main weapon — tracking for guild mates",
        alertBelow: 400000000,
      },
      {
        itemId: 51034,
        itemName: "Emeris",
        rarity: "celestial",
        type: "armour",
        currentLow: 1200000000,
        currentHigh: 1800000000,
        lastPrice: 1450000000,
        priceHistory: [
        ...
        circulation: 8,
        notes: "Best armour in game, extremely rare",
      },
      {
        itemId: 39882,
        itemName: "Damaged Archdemon Amulet (Str)",
        rarity: "legendary",
        type: "amulet",
        currentLow: 180000000,
        currentHigh: 320000000,
        lastPrice: 245000000,
        priceHistory: [
      ...
      },
      {
        ...
        rarity: "legendary",
        type: "shield",
        currentLow: 220000000,
        currentHigh: 380000000,
        lastPrice: 290000000,
        priceHistory: [
        ...
        circulation: 15,
        notes: "Price dipping — good buy window",
      },
    ];
    for (const item of marketItems) {
      await ctx.db.insert("marketTracking", {
        ...
        rarity: item.rarity,
        type: item.type,
        currentLow: item.currentLow,
        currentHigh: item.currentHigh,
    ...
    const personalItemsData = [
      ...
      {
        itemId: 90100,
        itemName: "Simpletopia Badge",
        category: "showcase",
        rarity: "legendary",
        quantity: 1,
        value: 0,
        isFavorite: true,
        notes: "Guardian of Simpletopia title proof",
      },
      {
        itemId: 90205,
        itemName: "Deer Antler Trophy",
        category: "showcase",
        rarity: "elite",
        quantity: 1,
        value: 0,
        isFavorite: true,
        notes: "The Deers guild war champion",
      },
      {
        itemId: 90310,
        itemName: "First Kill Medal",
        category: "showcase",
        rarity: "rare",
        quantity: 1,
        value: 0,
      ...
      {
        itemName: "Mortem Avatar (Dark)",
        category: "avatar",
        rarity: "legendary",
        quantity: 1,
        isFavorite: true,
        notes: "Death god theme",
      },
      {
        itemName: "Crystal Deer Avatar",
        category: "avatar",
        rarity: "elite",
        quantity: 1,
        isFavorite: false,
        notes: "Guild exclusive",
      },
      {
        itemName: "Honeycomb Set (Full)",
        category: "custom",
        rarity: "rare",
        quantity: 4,
        notes: "Axe + Harpoon + Pickaxe + Shovel",
        isFavorite: false,
      },
      {
        itemName: "War Trophies Collection",
        category: "custom",
        rarity: "legendary",
        quantity: 12,
        notes: "Drops from guild war victories",
        isFavorite: true,
      },
    ];
    ...
    for (const t of pvpQueueData) {
      await ctx.db.insert("pvpAssistantQueue", {
        userId,
        ...t,
        addedAt: now - Math.floor(Math.random() * 3600000),
      });
    }
    ...
    const blacklistData = [
      {
        targetPlayerId: 99001,
        targetName: "TrollMaster420",
        reason: "Retaliates with alt accounts",
      },
      {
        targetPlayerId: 99002,
        targetName: "AFK_Farmer",
        reason: "Not worth the gold — always broke",
      },
    ];
    ...
    const advisorMsgs = [
      {
        role: "system",
        content:
          "SMMO Strategic Advisor initialized. Analyzing The Guy's profile — Lv.29,727 Warrior with 52,400 STR.",
        category: "general",
      ...
      },
      {
        role: "user",
        content:
          "Should I invest more into DEX or keep pumping STR? I'm at 52.4K STR and 6.9K DEX.",
        category: "build",
    ...
    const vaultCodesData = [
      {
        ...
        redeemedAt: now - 86400000 * 19,
        notes: "Monthly code from Simple Wolf",
      },
      {
        code: "DEERPOWER",
        source: "simple_wolf",
        reward: "+10% STR Buff (2h)",
        rewardType: "buff",
        isRedeemed: true,
        addedAt: now - 86400000 * 14,
        redeemedAt: now - 86400000 * 13,
      },
      {
        code: "MORTEMRISES",
        source: "simple_wolf",
      ...
      },
      {
        code: "TREASUREHUNT50",
        source: "community",
        reward: "Rare Treasure Map",
        rewardType: "item",
        isRedeemed: false,
        addedAt: now - 86400000 * 1,
      },
      {
        code: "SPRING2026EVENT",
        source: "simple_wolf",
        reward: "Spring Event Box",
        rewardType: "item",
        isRedeemed: false,
        addedAt: now - 3600000,
        expiresAt: now + 86400000 * 7,
        notes: "Limited time spring event",
      },
      {
        code: "GUILDWAR500",
        source: "community",
    ...
    const collectionData = [
      ...
      },
      {
        ...
        rarity: "elite",
        source: "event",
        obtainedAt: now - 86400000 * 60,
        notes: "Guild exclusive",
      },
      {
        category: "avatar",
        itemName: "Golden Warrior Avatar",
        isOwned: true,
        rarity: "legendary",
        source: "shop",
        obtainedAt: now - 86400000 * 90,
      },
      {
        category: "avatar",
        itemName: "Celestial Knight Avatar",
        isOwned: false,
        rarity: "celestial",
        source: "boss",
        notes: "Drops from The Leviathan",
      },
      {
        category: "avatar",
        itemName: "Shadow Assassin Avatar",
        isOwned: false,
        rarity: "legendary",
        source: "craft",
      },
      {
        category: "avatar",
        itemName: "Spring Bloom Avatar",
        isOwned: true,
        rarity: "rare",
        source: "event",
        obtainedAt: now - 86400000 * 15,
      },
      {
        category: "avatar",
        itemName: "Fire Lord Avatar",
        isOwned: false,
        rarity: "legendary",
        source: "boss",
        notes: "Frost Wyrm drop",
      },
      {
        category: "avatar",
        itemName: "Pixel Art Avatar",
        isOwned: true,
        rarity: "common",
        source: "shop",
        obtainedAt: now - 86400000 * 120,
      },
      {
        category: "avatar",
        itemName: "Anniversary 2025 Avatar",
        isOwned: true,
        rarity: "elite",
        source: "event",
        obtainedAt: now - 86400000 * 200,
      },
      // Backgrounds
      {
        category: "background",
        itemName: "Simpletopia Sunset",
        isOwned: true,
        rarity: "rare",
        source: "quest",
        obtainedAt: now - 86400000 * 150,
      },
      {
        category: "background",
        ...
        rarity: "elite",
        source: "shop",
        obtainedAt: now - 86400000 * 100,
      },
      {
        category: "background",
        itemName: "Celestial Void",
        isOwned: false,
        rarity: "celestial",
        source: "boss",
      },
      {
        category: "background",
        itemName: "Guild War Arena",
        isOwned: true,
        rarity: "legendary",
        source: "event",
        obtainedAt: now - 86400000 * 30,
      },
      {
        category: "background",
        itemName: "Ocean Depths",
        isOwned: false,
        rarity: "rare",
        source: "quest",
      },
      ...
      {
        category: "title",
        itemName: "Guardian of Simpletopia",
        isOwned: true,
        rarity: "legendary",
        source: "quest",
        obtainedAt: now - 86400000 * 80,
        notes: "Current title",
      },
      {
        category: "title",
        itemName: "War Veteran",
        isOwned: true,
        rarity: "elite",
        source: "event",
        obtainedAt: now - 86400000 * 40,
      },
      {
        category: "title",
      ...
      {
        category: "title",
        itemName: "Market Mogul",
        isOwned: false,
        rarity: "elite",
        source: "trade",
        notes: "Need 50K market trades",
      },
      {
        category: "title",
        itemName: "The Unstoppable",
        isOwned: false,
        rarity: "celestial",
        source: "quest",
        notes: "100K PvP kills required",
      },
      // Badges
      {
        category: "badge",
        itemName: "First Blood",
        isOwned: true,
        rarity: "common",
        source: "quest",
        obtainedAt: now - 86400000 * 280,
      },
      {
        category: "badge",
        itemName: "10K PvP Kills",
        isOwned: true,
        rarity: "rare",
        source: "quest",
        obtainedAt: now - 86400000 * 100,
      ...
      {
        category: "badge",
        itemName: "25K PvP Kills",
        isOwned: true,
        rarity: "elite",
        source: "quest",
        obtainedAt: now - 86400000 * 20,
      },
      {
        category: "badge",
        itemName: "50K PvP Kills",
        isOwned: false,
        rarity: "legendary",
        source: "quest",
        notes: "29,427 / 50,000",
      ...
      {
        category: "badge",
        itemName: "Boss Hunter",
        isOwned: true,
        rarity: "rare",
        source: "boss",
        obtainedAt: now - 86400000 * 50,
      },
      {
        category: "badge",
        itemName: "Guild Champion",
        isOwned: true,
        rarity: "legendary",
        source: "event",
        obtainedAt: now - 86400000 * 10,
      },
    ];
    ...
    const tasksData = [
      ...
      {
        taskType: "daily",
        description: "Win 15 PvP battles",
        currentAmount: 15,
        targetAmount: 15,
        expReward: 200000,
        otherReward: "1x Bronze Key",
        isCompleted: true,
      },
      {
        taskType: "daily",
        description: "Take 500 steps",
        currentAmount: 234,
        targetAmount: 500,
        expReward: 80000,
        isCompleted: false,
      ...
      {
        taskType: "weekly",
        description: "Kill 200 players in PvP",
        currentAmount: 147,
        targetAmount: 200,
        expReward: 890000,
        otherReward: "1x Gold Key",
        isCompleted: false,
        refreshAt: now + 5 * 86400000,
      },
      {
        taskType: "weekly",
        description: "Complete 70 quests",
        currentAmount: 42,
        targetAmount: 70,
        expReward: 750000,
        otherReward: "1x Gold Key",
      ...
      {
        taskType: "weekly",
        description: "Gather 150 materials",
        currentAmount: 67,
        targetAmount: 150,
        expReward: 500000,
        isCompleted: false,
      ...
      {
        taskType: "monthly",
        description: "Kill 395 players in PvP",
        currentAmount: 395,
        targetAmount: 395,
        expReward: 2080960,
        otherReward: "2x Gold Keys",
        isCompleted: true,
        refreshAt: now + 12 * 86400000,
      },
      {
        taskType: "monthly",
        description: "Gather 675 materials while travelling",
        currentAmount: 7,
        targetAmount: 675,
        expReward: 2080960,
        otherReward: "2x Gold Keys",
      ...
      {
        taskType: "monthly",
        description: "Successfully perform 740 quests",
        currentAmount: 168,
        targetAmount: 740,
        expReward: 2080960,
        otherReward: "2x Gold Keys",
    ...
    const modifiersData = [
      // Travel modifiers
      {
        ...
        totalPercent: 5,
        sourceCount: 1,
        sources: [{ name: "Orphanage", percent: 5, isPermanent: false }],
      },
      {
        category: "travel",
        ...
        sources: [
          {
            name: "Potion",
            percent: 5,
            expiresAt: now + 158000,
            isPermanent: false,
          },
          {
            name: "Temple",
            percent: 15,
            expiresAt: now + 3578000,
            isPermanent: false,
          },
        ],
      },
      ...
      // Quest modifiers
      {
        ...
        totalPercent: 10,
        sourceCount: 1,
        sources: [{ name: "Sanctuary", percent: 10, isPermanent: false }],
      },
    ];
    ...
    const watchlistData = [
      {
        watchedPlayerId: 112045,
        watchedPlayerName: "DeerKing",
        watchedPlayerLevel: 31200,
        watchedPlayerGuildName: "The Deers",
        watchedPlayerStr: 58900,
        watchedPlayerDef: 4200,
        watchedPlayerDex: 7500,
        watchedPlayerHp: 210000,
        watchedPlayerMaxHp: 210000,
        watchedPlayerGold: 250000,
        watchedPlayerSafeMode: false,
        watchedPlayerLastActivity: now - 300000,
        tag: "friend",
        notes: "Guild leader — coordinate war targets",
        addedAt: now - 86400000 * 60,
        lastChecked: now - 600000,
      },
      {
        watchedPlayerId: 456789,
        watchedPlayerName: "MoonlitBlade",
        watchedPlayerLevel: 30500,
        watchedPlayerGuildName: "The Deers",
        watchedPlayerStr: 54200,
        watchedPlayerDef: 3900,
        watchedPlayerDex: 6800,
        watchedPlayerHp: 45000,
        watchedPlayerMaxHp: 168000,
        watchedPlayerGold: 89000,
        watchedPlayerSafeMode: false,
        watchedPlayerLastActivity: now - 900000,
        tag: "friend",
        notes: "Low HP — might need backup in war",
        addedAt: now - 86400000 * 30,
        lastChecked: now - 1800000,
      },
      {
        watchedPlayerId: 23891,
        watchedPlayerName: "NightBlade99",
        watchedPlayerLevel: 30100,
        watchedPlayerGuildName: "Dark Knights",
        watchedPlayerStr: 55100,
        watchedPlayerDef: 4100,
        watchedPlayerDex: 7200,
        watchedPlayerHp: 145000,
        watchedPlayerMaxHp: 145000,
        watchedPlayerGold: 82000,
        watchedPlayerSafeMode: false,
        watchedPlayerLastActivity: now - 7200000,
        tag: "enemy",
        notes: "Top DK player — focus in wars",
        addedAt: now - 86400000 * 14,
        lastChecked: now - 3600000,
      },
      {
        watchedPlayerId: 89012,
        watchedPlayerName: "MoonWalker",
        watchedPlayerLevel: 31000,
        watchedPlayerGuildName: "Shadow Realm",
        watchedPlayerStr: 57200,
        watchedPlayerDef: 4500,
        watchedPlayerDex: 7800,
        watchedPlayerHp: 48000,
        watchedPlayerMaxHp: 155000,
        watchedPlayerGold: 110000,
        watchedPlayerSafeMode: false,
        watchedPlayerLastActivity: now - 14400000,
        tag: "enemy",
        notes: "High STR but low HP — easy target when weakened",
        addedAt: now - 86400000 * 7,
        lastChecked: now - 7200000,
      },
      {
        watchedPlayerId: 510234,
        watchedPlayerName: "DiamondDealer",
        watchedPlayerLevel: 22100,
        watchedPlayerGuildName: undefined,
        watchedPlayerStr: 28500,
        watchedPlayerDef: 1800,
        watchedPlayerDex: 3200,
        watchedPlayerHp: 95000,
        watchedPlayerMaxHp: 95000,
        watchedPlayerGold: 5000000,
        watchedPlayerSafeMode: true,
        watchedPlayerLastActivity: now - 43200000,
        tag: "trader",
        notes: "Best diamond prices — check daily",
        addedAt: now - 86400000 * 10,
        lastChecked: now - 43200000,
      },
      {
        watchedPlayerId: 67890,
        watchedPlayerName: "StormRider",
        watchedPlayerLevel: 29800,
        watchedPlayerGuildName: "Dark Knights",
        watchedPlayerStr: 49800,
        watchedPlayerDef: 3600,
        watchedPlayerDex: 6100,
        watchedPlayerHp: 91000,
        watchedPlayerMaxHp: 140000,
        watchedPlayerGold: 54000,
        watchedPlayerSafeMode: false,
        watchedPlayerLastActivity: now - 5400000,
        tag: "enemy",
        notes: "Second most kills on DK side",
        addedAt: now - 86400000 * 14,
        lastChecked: now - 5400000,
      },
    ];
  ...
  returns: v.array(
    v.object({
      ...
      priceHistory: v.optional(
        v.array(v.object({ price: v.number(), timestamp: v.number() })),
      ),
...
export const addVaultCode = mutation({
  ...
  handler: async (ctx, args) => {
    const userId = await getAuthUserId(ctx);
    if (!userId) return null;
    await ctx.db.insert("vaultCodes", {
      userId,
      ...args,
      isRedeemed: false,
      addedAt: Date.now(),
...
export const toggleVaultRedeemed = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.codeId, {
      ...
      redeemedAt: !code.isRedeemed ? Date.now() : undefined,
    });
    return null;
  },
});
...
export const toggleCollectionOwned = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.itemId, {
      ...
      obtainedAt: !item.isOwned ? Date.now() : undefined,
    });
    return null;
  },
});
...
export const updateWatchlistNotes = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (entry && entry.userId === userId)
      await ctx.db.patch(args.entryId, { notes: args.notes });
    return null;
  },
});
