...
export function getRarityBorder(rarity?: string): string {
  switch (rarity) {
    case "legendary":
      return "border-rarity-legendary/40";
    case "celestial":
      return "border-rarity-celestial/40";
    case "elite":
      return "border-rarity-elite/30";
    case "rare":
      return "border-rarity-rare/30";
    default:
